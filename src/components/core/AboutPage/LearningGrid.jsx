...
const LearningGrid = () =>{
    ...
    return(<div className=" grid mx-auto lg:grid-cols-4 grid-cols-1 mb-10  mt-[100px]             ">
         {
            LearningGridArray.map((card,index)=> (
                ...
                `}> 
        {
            card.order < 0 ? (<div className=" self-start  lg:w-[90%] flex flex-col  gap-6 p- b">
            ...
            </div>) : (<div className=" text-white flex-col gap-12 p-7">
